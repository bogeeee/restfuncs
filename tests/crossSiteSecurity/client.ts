...
import {TestsService} from "./TestsService"; // Import to have types

const mainSiteUrl = "http://localhost:3000";
const isMainSite = window.location.href.startsWith(mainSiteUrl);
