...
export class ServerSession {
     ...
     */
    protected static getMethodNameForCall(httpMethod: RegularHttpMethod, target: ServerSession | ClassOf<ServerSession>, path: string): string | null {
        if(path === "") {
            path = "index";
        }
