...
export type CommunicationErrorOptions = ErrorOptions & {
    /**
...
export class CommunicationError extends Error {
     ...
     */
    public isCommunicationError= true;

    public log?: boolean;

    constructor(message: string, options?: CommunicationErrorOptions ) {
...
export function isCommunicationError(error: Error) {
    // @ts-ignore
    return error.isCommunicationError
}